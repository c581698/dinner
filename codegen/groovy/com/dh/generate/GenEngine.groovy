...
class GenEngine {
	...
	static void main(arg){
		...
		cfg.setDirectoryForTemplateLoading(new File(basePath+"/gen/ftl"));
	...
	static void init(){
		...
		props.load(new FileInputStream(basePath+"/gen/gen.properties"));
		...
		props.load(new FileInputStream(basePath+"/gen/table.properties"));
